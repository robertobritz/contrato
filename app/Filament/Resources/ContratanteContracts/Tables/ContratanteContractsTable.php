...
namespace App\Filament\Resources\ContratanteContracts\Tables;
...
class ContratanteContractsTable
{
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('export_pdf')
                    ...
                    ->color('danger')
                    ->url(fn(ContratanteContract $record) => route('contracts.export.pdf', $record))
                    ->openUrlInNewTab(),
                Action::make('export_docx')
                    ->label('DOCX')
                    ->icon('heroicon-o-document-arrow-down')
                    ->color('info')
                    ->url(fn(ContratanteContract $record) => route('contracts.export.docx', $record))
                    ->openUrlInNewTab(),
