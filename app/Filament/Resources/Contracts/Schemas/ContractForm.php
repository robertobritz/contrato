                ...
                Section::make('Conteúdo')
                    ->schema([
                        RichEditor::make('body')
                            ...
                            ->required()
                            ->columnSpanFull()
                            ->helperText('Use variáveis como $cliente.nome, $cliente.cpf, etc. para dados dinâmicos. Utilize o botão flutuante "Variáveis" no canto inferior direito para copiar as variáveis disponíveis.'),
                    ]),
            ]);
    }
}
